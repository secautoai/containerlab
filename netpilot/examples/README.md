...
These are generated by `scratchpad/build_labs.py` (the verification harness),
which creates each topology through the API, writes the FRR configs, boots the
nodes, and asserts the protocol state shown above.
